                ...
                <table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="49">
                            <div align="center">
											<span class="STYLE22">
											<a href="${contextPath }/categorySearch?cid=${cid}&current=1" onclick="<#if page.current lte 1>return false</#if>">首页</a>
											</span>
                            </div>
                        </td>
                        ...
                        <td width="49">
                            <div align="center">
                                <span class="STYLE22">
                                    <a href="${contextPath }/categorySearch?cid=${cid}&current=${page.current-1}" onclick="<#if page.current lte 1>return false</#if>">上一页</a>
                                </span>
                            </div>
                        </td>
                        ...
                        <td width="49">
                            <div align="center">
                                <span class="STYLE22">
                                    <a href="${contextPath }/categorySearch?cid=${cid}&current=${page.current+1}" onclick="<#if page.current gte page.pages>return false</#if>">下一页</a>
                                </span>
                            </div>
                        </td>
                        ...
                        <td width="49">
                            <div align="center">
                                <span class="STYLE22">
                                    <a href="${contextPath }/categorySearch?cid=${cid}&current=${page.pages }" onclick="<#if page.current gte page.pages>return false</#if>">尾页</a>
                                </span>
                            </div>
                        </td>
...
<script>
    function jump() {
        ...
        window.location.href = "${contextPath}/categorySearch?cid=${cid}&current="
            + num;
