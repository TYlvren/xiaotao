...
<div class="modal-wrapper" aria-hidden="true">
    <div class="modal-dialog absolute-position" tabindex="0" role="dialog" aria-labelledby=":i"
         style="width: 550px;left:50%">
                ...
                <form class="js-add-question-form" style="display: block;">
                    <div class="zg-section-big clearfix">
                        ...
                        <div style="display: none;position: relative;" id="zm-modal-dialog-warnmsg-wrapper">
                            ...
                            <a name="close" title="关闭" href="javascript:;" class="zu-global-notify-close"
                        ...
                        <div class="zg-form-text-input add-question-title-form" style="position: relative;">
                            <textarea id="msg_to" rows="1" class="zg-editor-input zu-seamless-input-origin-element"
                                      title="在这里输入" id="zh-question-suggest-title-content" aria-label="在这里输入接收方"
                                      placeholder="请输入接收方的用户名" role="combobox" aria-autocomplete="list" autocomplete="off"
                                      style="height: 22px;">${toName!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="zm-command">
                        ...
                        <a href="javascript:sendMsg();" name="addq"
                           class="zg-r5px zu-question-form-add zg-btn-blue">发送</a>
                        <a name="jumpq" class="zg-r5px zg-btn-blue zu-question-form-jump" style="display:none;">查看问题</a>
                    </div>
                </form>
            </div>
        </div>
